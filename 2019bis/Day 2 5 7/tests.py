...
class Opcode99(unittest.TestCase):
    ...
    def test_takingStepUnknownOpcodeMessage(self):
        message = self.testComputer.takeStep()
        self.assertEqual(self.referenceMessage, message)
